...
public class Camera2VideoImageActivity_bak extends AppCompatActivity {
...
//        createImageFolder();
        ...
        mRecordImageButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mIsRecording || mIsTimelapse) {
                    ...
                    Toast.makeText(Camera2VideoImageActivity_bak.this, "Finalizando grabación", Toast.LENGTH_SHORT).show();
                    mChronometer.stop();
                    ...
                    Toast.makeText(Camera2VideoImageActivity_bak.this, "Iniciando grabación", Toast.LENGTH_SHORT).show();
                    mIsRecording = true;
    ...
    private void startRecord() {
        try {
            if (mIsRecording) {
                setupMediaRecorder(VideoFactory.getInstance());
            ...
            mCameraDevice.createCaptureSession(Arrays.asList(previewSurface, recordSurface, mImageReader.getSurface()),
                    new CameraCaptureSession.StateCallback() {
                        ...
                        public void onConfigureFailed(CameraCaptureSession session) {
                            Toast.makeText(Camera2VideoImageActivity_bak.this, "No se pudo iniciar sesión de captura!", Toast.LENGTH_SHORT).show();
...
//
    private File createVideoFileName() throws IOException {
        ...
        File videoFile = File.createTempFile(prepend, ".mp4", Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_MOVIES));
...
//
    ...
    private void checkWriteStoragePermission() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            if (ContextCompat.checkSelfPermission(this, Manifest.permission.WRITE_EXTERNAL_STORAGE)
                ...
                startRecord(); //BAD: Oculta el setup()
                mMediaRecorder.start();
                mChronometer.setBase(SystemClock.elapsedRealtime());
                mChronometer.setVisibility(View.VISIBLE);
                mChronometer.start();
    ...
    private void setupMediaRecorder(MediaAbstractFactory mediaAbstractFactory) throws IOException {
    ...
    private void setupTimelapse(MediaAbstractFactory mediaAbstractFactory) throws IOException {
        mMediaRecorder.setVideoSource(MediaRecorder.VideoSource.SURFACE);
